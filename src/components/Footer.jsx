            ...
            <div className="max-w-container-footer m-auto flex flex-wrap justify-between px-4">
                <div className="footer-item lg:w-2/5 w-full lg:mb-0 mb-12 pr-10">
                    <div className="footer-logo mb-6">
                        <Link href="/">
                            <a className="cursor-pointer w-full h-full inline-block">
                                <Image
                                    src="/footer-logo.png"
                                    alt="gravity"
                                    width={300}
                    ...
                    <div className="footer-social flex items-center">
                        <div className="icon mr-6">
                            <Link href="#">
                                <a className="cursor-pointer border-2 border-solid border-primary w-10 h-10 flex justify-center items-center rounded-full">
                ...
                <div className="footer-item lg:w-1/5 sm:w-2/6 w-full lg:mb-0 mb-12 lg:pl-10">
                    ...
                    <ul>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Getting started</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Documentation </a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Tutorials</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">FAQ</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Github</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Audits</a></Link></li>
                    </ul>
                </div>
                <div className="footer-item lg:w-1/5 sm:w-2/6 w-full lg:mb-0 mb-12 lg:pl-10">
                    <h4 className="font-bold sm:text-base text-sm text-primary mb-4 tracking-widest">PRODUCTS</h4>
                    <ul>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Exchange</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Liquidity</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Farms</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Vaults</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Launchpad</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Governance</a></Link></li>
                    </ul>
                </div>
                <div className="footer-item lg:w-1/5 sm:w-2/6 w-full lg:pl-10">
                    ...
                    <ul>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Discord</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Medium</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">Telegram</a></Link></li>
                        <li><Link href="#"><a className="cursor-pointer font-bold sm:text-base text-sm text-white mb-3 inline-block">twitter</a></Link></li>
                    </ul>
                </div>
            </div>
        </footer>
